...
import { quicksort, timsort } from '../src/sort/index.js';
import { binarySearch, lowerBound } from '../src/search/index.js';
...
writeVectors('tests/vectors/crypto/sha256.json', {
  ...
  standard: 'FIPS 180-4',
  vectors: [
    { id: 'sha256-001', input_hex: '', expected_hex: 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855' },
    ...
    { id: 'sha256-004', input_utf8: 'LombokAlgoritma', expected_hex: toHex(sha256('LombokAlgoritma')) },
  ]
});
...
writeVectors('tests/vectors/sort/quicksort.json', { algorithm: 'quicksort', version: '0.1.0', vectors: sortCases });
writeVectors('tests/vectors/sort/timsort.json', { algorithm: 'timsort', version: '0.1.0', vectors: sortCases });
writeVectors('tests/vectors/sort/mergesort.json', { algorithm: 'mergesort', version: '0.1.0', vectors: sortCases });
