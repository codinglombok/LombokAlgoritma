...
describe('binarySearch', () => {
  ...
  it('finds last element', () => {
    expect(binarySearch(sorted, 19)).toBe(9);
  });
...
describe('lowerBound / upperBound', () => {
  ...
  it('lowerBound past end', () => {
    expect(lowerBound(arr, 10)).toBe(6);
  });
  it('lowerBound before start', () => {
...
describe('interpolationSearch', () => {
  ...
  it('finds midpoint', () => {
    expect(interpolationSearch(uniform, 50)).toBe(25);
  });
  it('returns -1 for missing', () => {
    expect(interpolationSearch(uniform, 3)).toBe(-1);
  });
});

describe('exponentialSearch', () => {
  it('finds element', () => {
    expect(exponentialSearch(sorted, 13)).toBe(6);
  });
  it('first element', () => {
    expect(exponentialSearch(sorted, 1)).toBe(0);
  });
  it('missing', () => {
    expect(exponentialSearch(sorted, 8)).toBe(-1);
  });
});

describe('jumpSearch', () => {
  it('finds element', () => {
    expect(jumpSearch(sorted, 9)).toBe(4);
  });
  it('missing', () => {
    expect(jumpSearch(sorted, 6)).toBe(-1);
  });
});

describe('fibonacciSearch', () => {
  it('finds element', () => {
    expect(fibonacciSearch(sorted, 11)).toBe(5);
  });
  it('missing', () => {
    expect(fibonacciSearch(sorted, 2)).toBe(-1);
  });
});
...
describe('linearSearch', () => {
  ...
  it('first occurrence', () => {
    expect(linearSearch([3, 1, 4, 1, 5], 1)).toBe(1);
  });
  it('missing', () => {
    expect(linearSearch([3, 1, 4], 2)).toBe(-1);
  });
});
